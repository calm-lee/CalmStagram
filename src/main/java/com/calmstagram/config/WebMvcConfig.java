package com.calmstagram.config;
...
import com.calmstagram.interceptor.PermissionInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer{
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) { //내 서버에 있는 이미지파일을 가져와서 mapping을 할 수 있도록 해줌
		registry.addResourceHandler("/images/**") // 웹 URI가 /images/ 이하의 파일들을 요청할 경우
		        .addResourceLocations("file:/D:\\Spring Project\\SNS_Project\\Calmstagram\\src\\main\\resources\\static\\images/"); // 여기에 저장된 파일들을 찾아서 보여줌
